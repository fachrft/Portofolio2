    ...
    return (
        <div className="h-[40vh] pt-8 lg:px-24">
            ...
            <div className="px-10 w-full pt-8 flex flex-wrap gap-2 lg:w-[60vw]">
                <div className="shadow-2xl shadow-teal-500 px-2 py-1 flex items-start justify-start rounded-md bg-white">
                ...
                <div className="px-2 py-1 flex items-start justify-center rounded-md bg-white">
                ...
                <div className=" px-3 py-2 flex items-start justify-center rounded-md bg-white">
