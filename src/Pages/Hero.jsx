    ...
    return (
        <section className="pt-40 h-[100vh] lg:px-40">
            <div className="container lg:flex lg:justify-center lg:items-center">
                <div className="p-6 text-white lg:flex lg:flex-col gap-4 lg:pt-2r lg:pr-20 lg:w-1/2 " data-aos="fade-up" data-aos-duration="3000">
                    ...
                    <div className="mt-4 flex justify-center lg:justify-start">
                        <div className="p-2 bg-sky-800 rounded-full text-center w-36 lg:w-52">
                            <a href="../../public/CV FACHRIFAT ZHAFRAN.pdf" download className="lg:text-xl cursor-pointer">
                                Download Cv
                            </a>
                        </div>
                    </div>
