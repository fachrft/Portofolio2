        ...
        <main className="pt-10 lg:px-24" id="about">
            <div className="container px-2 pt-8">
                <div className="flex justify-between lg:justify-start">
                    {/* Image */}
                    <div className="max-w-sm w-56 lg:max-w-xl lg:w-[400px]" data-aos="fade-right" data-aos-offset="400" data-aos-easing="ease-in-sine">
                    ...
                    <div className="max-w-sm flex flex-col w-56 h-52 lg:w-96 lg:pt-18 lg:items-start lg:px-5" data-aos="fade-down">
                        ...
                        <div className="text-start text-white h-13">
                            <h1 className="lg:text-2xl lg:pl-0 font-bold">05/02/2006</h1>
                            <h1 className="text-xs lg:text-2xl lg:pl-0 font-bold">fachrifat05@gmail.com</h1>
                        </div>
                        <div className="flex gap-2 pt-3">
                            <div class="flex items-center">
                                <a href="https://www.linkedin.com/in/fachrifat-zhafran-29a44925a/" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-400 hover:border-primary text-white bg-white hover:text-black">
                                ...
                                <a href="https://www.instagram.com/fachrftzhafrn_/" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-400 hover:border-primary bg-white">
                                ...
                                <a href="https://github.com/fachrft" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-400 hover:border-primary bg-white">
                ...
                <div className="pt-5 mx-w-md px-3 flex justify-between lg:justify-end lg:gap-10 lg:relative lg:-top-56 lg:px-24" data-aos="fade-left" data-aos-offset="200" data-aos-easing="ease-in-sine">
